...
MoveEnd:
	...
	move TRI_ATTACK,	TRI_ATTACK_EFFECT,		 80,	NORMAL,		SPECIAL,	100,	10,	20 ; change to its own effect
...
; NEW MOVES
	move WITHDRAW,		PROTECT_EFFECT,		 	  0,	NORMAL,		STATUS_M,	100,	10,	 0 ; PROTECT
	...
	move FLAMETHROWER,	BURN_EFFECT,			  0,	FIRE,		STATUS_M,	 85,	15,	 0 ; WILL O WISP
	...
	move AMNESIA,		SPECIAL_UP2_EFFECT,		  0,	DARK,		STATUS_M,	100,	20,	 0 ; NASTY PLOT
	...
	move ROCK_THROW,	STEALTH_ROCK_EFFECT,	  0,	ROCK,		STATUS_M,	100,	20,	 0 ; STEALTH ROCK
	move WATERFALL,		EFFECT_NORMAL_HIT,		 40,	WATER,		PHYSICAL,	100,	20,	 0 ; AQUA JET
	move AGILITY,		SPECIAL_UP1_EFFECT,		  0,	BUG,		STATUS_M,	100,	20,	 0 ; QUIVER DANCE
	...
	move WATER_GUN,		EFFECT_BURN_HIT,		 80,	WATER,		SPECIAL,	100,	15,	 0 ; SCALD
	move SKULL_BASH,	ATTACK_UP1_EFFECT,		  0,	NORMAL,		STATUS_M,	100,	15,	 0 ; SHELL SMASH
