...
ProfOakData:
; Unused
	db $FF,65,TAUROS,66,CLEFABLE,67,VENUSAUR,68,CHARIZARD,69,BLASTOISE,70,GYARADOS,0
ChiefData:
; none
ScientistData:
; Unused
...
; Viridian Gym
	db $FF,50,PERSIAN,52,DUGTRIO,53,NIDOQUEEN,53,NIDOKING,55,RHYDON,55,MEWTWO_A,0
RocketData:
; Mt. Moon B2F
...
Green2Data:
; SS Anne 2F
	db $FF,19,SPEAROW,16,RATTATA,18,SANDSHREW,20,EEVEE,0   ; if you chose Pikachu
	db $FF,19,PIDGEOTTO,16,RATTATA,18,KADABRA,20,PIKACHU,0 ; If you chose Eevee
; Pokémon Tower 2F
	db $FF,25,FEAROW,23,SHELLDER,22,VULPIX,20,SANDSHREW,25,EEVEE,0       ; JOLTEON TEAM
	db $FF,25,FEAROW,23,MAGNEMITE,22,SHELLDER,20,SANDSHREW,25,EEVEE,0    ; FLAREON TEAM
	db $FF,25,FEAROW,23,VULPIX,22,MAGNEMITE,20,SANDSHREW,25,EEVEE,0      ; VAPOREON TEAM
	db $FF,25,PIDGEOTTO,23,GROWLITHE,22,GYARADOS,20,KADABRA,25,PIKACHU,0 ; RAICHU TEAM - If you chose Eevee
; Silph Co. 7F
	...
	db $FF,38,PIDGEOT,35,GROWLITHE,37,GYARADOS,35,ALAKAZAM,40,RAICHU,0
; Route 22
	...
	db $FF,47,PIDGEOT,45,RHYHORN,45,GROWLITHE,47,GYARADOS,50,ALAKAZAM,53,RAICHU,0
Green3Data:
; CHAMPION
	...
	db $FF,61,PIDGEOT,59,ALAKAZAM,61,EXEGGUTOR,61,RHYDON,63,GYARADOS,65,RAICHU,0
; REMATCH @ VIRIDIAN GYM
	db $FF,72,SANDSLASH,70,ALAKAZAM,71,EXEGGUTOR,72,CLOYSTER,74,NINETALES,75,JOLTEON,0
	db $FF,72,SANDSLASH,70,ALAKAZAM,71,EXEGGUTOR,72,MAGNEZONE,74,CLOYSTER,75,FLAREON,0
	db $FF,72,SANDSLASH,70,ALAKAZAM,71,EXEGGUTOR,72,NINETALES,74,MAGNEZONE,75,VAPOREON,0
	db $FF,72,PIDGEOT,70,ALAKAZAM,71,EXEGGUTOR,72,RHYPERIOR,74,GYARADOS,75,RAICHU,0
LoreleiData:
