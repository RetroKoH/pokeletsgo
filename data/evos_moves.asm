...
; Evolutions
	...
	db 0
; Learnset - Knows Thundershock and Charm
        db 3, TAIL_WHIP
        db 6, QUICK_ATTACK
        ;db 9, SWEET_KISS
        ;db 12, NASTY_PLOT
...
;Learnset
	...
	db 10,DOUBLE_KICK
        db 14,SAND_ATTACK
	;db 17,SHADOW_BALL
	db 21,KINESIS      ; Should I replace this with a different debuff move?
	;db 24,CALM_MIND
	db 28,PSYCHIC_M
	db 0
...
;Learnset
	...
	db 10,DOUBLE_KICK
        db 14,SAND_ATTACK
	db 17,MEGA_DRAIN
	;db 21,X_SCISSOR ; Replace with a debuff move, if possible
	db 24,GROWTH
	db 28,SOLARBEAM
	db 0
...
;Learnset
	...
	db 10,DOUBLE_KICK
        db 14,SAND_ATTACK
	db 17,AURORA_BEAM ; Maybe replace?
	;db 21,X_SCISSOR ; debuff move, if possible
	db 24,BARRIER
	db 28,BLIZZARD
	db 0
...
;Learnset
	...
	db 10,DOUBLE_KICK
        db 14,SAND_ATTACK
	;db 17,DAZZLE_GLEAM
	db 21,SWIFT ; debuff move, if possible
	db 24,LIGHT_SCREEN
	;db 28,MOONBLAST
	db 0
