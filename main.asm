...
BattleHudTiles1:         INCBIN "gfx/gen2_battle_arrow.1bpp"
BattleHudTiles1End:
BattleHudTiles2:         INCBIN "gfx/gen2_battle_arrow_lines.1bpp"
BattleHudTiles3:         INCBIN "gfx/gen2_battle_arrow_more_lines.1bpp"
BattleHudTiles3End:
...
INCLUDE "engine/battle/moveEffects/stealth_rock_effect.asm"
...
Version_GFX:
	INCBIN "gfx/letsgoyellow.1bpp" ; 10 tiles
Version_GFXEnd:
