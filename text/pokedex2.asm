...
_MagmortarDexEntry:: ;[Let's Go Edit: Expanded Dex]
	...
	page "2,000 degrees C."
	next "It mostly lives in"
...
_SylveonDexEntry:: ;[Let's Go Edit: Expanded Dex]
	...
	page "feelers can calm"
	next "fights and weaken"
	next "prey for an attack"
	dex
...
_MunchlaxDexEntry::
	text "Needs to eat its"
	next "weight in food"
	next "every day. As far"

	page "as the flavor"
	next "is concerned, it's"
	next "quite indifferent."
	dex
...
_MeltanDexEntry::
	...
	next "of iron found in"
	next "the subsoil, so it"

	page "can absorb them"
	next "into its body of"
	next "molten steel"
	dex

_MelmetalDexEntry::
	text "Once revered for"
	next "its ability to"
	next "create iron from"

	page "nothing, it's come"
	next "back to life after"
	next "about 3,000 years"
	dex
