...
_RattataADexEntry::
	text "Its whiskers give"
	next "it a keen sense of"
	next "smell. It can pick"

	page "up the scent of"
	next "hidden food and"
	next "find it instantly"
	dex
...
_RaticateADexEntry::
	text "It makes Rattata"
	next "underlings gather"
	next "food for it,"

	page "dining only on the"
	next "most delicious and"
	next "nutritious fare"
	dex
...
_PikachuSDexEntry::
	text "This wild PIKACHU"
	next "was just caught by"
	next "Professor Oak."
...
_LickilickyDexEntry::
	...
	page "has a solvent that"
	next "can cause ongoing"
	next "numbness"
	dex
